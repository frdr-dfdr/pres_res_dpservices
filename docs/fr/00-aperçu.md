...
|Planification de la préservation|Élaboration d'un plan d'action pour la préservation et d'une matrice des risques qui seront rendus publics via le [registre des politiques de format](https://github.com/frdr-dfdr/pres_res_fpr) des services.|
